...
export declare class ProductController {
    ...
    getAllproducts(sort: Sort, sortby: string, page: string): Promise<import(".prisma/client").Product[]>;
    searchProductspost(sort: Sort, sortby: string, filters: any, name: string, text: string, min_price: string, max_price: string, producer: string, page: string): Promise<import(".prisma/client").Product[]>;
    searchProductss(sort: Sort, sortby: string, name: string, text: string, min_price: string, max_price: string, producer: string, page: string): Promise<import(".prisma/client").Product[]>;
